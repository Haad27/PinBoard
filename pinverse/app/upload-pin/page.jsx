        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-5/12 bg-blue-50/50 p-8 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-blue-100">
            <div
              ...
              className={`group relative w-full aspect-[4/5] bg-white border-2 border-dashed rounded-3xl flex flex-col items-center justify-center cursor-pointer transition-all duration-300 ${
                imagePreview
                  ? "border-blue-400"
          ...
          <div className="w-full md:w-7/12 p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-4 mt-4 rounded-2xl font-bold text-white transition-all shadow-xl ${
                  loading
